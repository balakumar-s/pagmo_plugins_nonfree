...
BOOST_AUTO_TEST_CASE(construction)
{
    ...
    BOOST_CHECK_NO_THROW((snopt7{false, SNOPT_FOLDER}));
    BOOST_CHECK_NO_THROW((snopt7{true, SNOPT_FOLDER}));
    BOOST_CHECK_NO_THROW((snopt7{true, "dummy"}));
    // We test construction of a snopt7 pagmo algorithm
    BOOST_CHECK_NO_THROW((algorithm{snopt7{false, SNOPT_FOLDER}}));
    BOOST_CHECK_NO_THROW((algorithm{snopt7{true, SNOPT_FOLDER}}));
    BOOST_CHECK_NO_THROW((algorithm{snopt7{true, "dummy"}}));
}
...
BOOST_AUTO_TEST_CASE(option_setting_mechanism)
{
    ...
    snopt7 uda{snopt7{true,SNOPT_FOLDER}};
...
BOOST_AUTO_TEST_CASE(serialization_test)
{
    ...
    algorithm algo{snopt7{false,  SNOPT_FOLDER}};
